                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                  ...
                                  <th>Action</th>
                                    ...
                                    <tbody>
                                              <?php $ret=mysqli_query($con,"select * from children where date(born)=CURRENT_DATE()-1");
                              $cnt=1;
                          ...
                          <i class="fas fa-edit"></i></a>
                                     ...
                                     <a href="schedule.php?uid=<?php echo $row['id'];?>"><img src="schedule.jpg" height="30px" width="20px"></a> 
                                  </td>
                              </tr>
                              <?php $cnt=$cnt+1; }?>
