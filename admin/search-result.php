...
Search Results</h1>
            ...
            <h3>Search Results for '<?php echo $_POST['searchkey'];?>'</h3>
                        <div class="card mb-4">
...
$ret=mysqli_query($con,"select * from customer3 where (full_name like '%$searchkey%' || father like '%$searchkey%' || mother like '%$searchkey%')");
                              $cnt=1;
