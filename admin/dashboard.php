            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
<?php
$query=mysqli_query($con,"select id from children");
$totalusers=mysqli_num_rows($query);
?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Total Registered Children 
...
<?php
$query1=mysqli_query($con,"select id from children where date(born)=CURRENT_DATE()-1");
$yesterdayregusers=mysqli_num_rows($query1);
?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">Yesterday Registered Children 
...
<?php
$query2=mysqli_query($con,"select id from children where date(born)>=now() - INTERVAL 7 day");
$last7daysregusers=mysqli_num_rows($query2);
?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body"> Registered children in Last 7 Days
...
<?php
$query3=mysqli_query($con,"select * from parents ");
$last30daysregusers=mysqli_num_rows($query3);
?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Total Registered parents 
