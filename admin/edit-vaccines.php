...
$userid=$_GET['uid'];
    $msg=mysqli_query($con,"update vaccines set name='$fname',period='$lname',message='$contact' where id='$userid'");
...
<html lang="en">
    <head>
        ...
        <title>Edit vaccines Profile | SBCS</title>
...
<?php 
$userid=$_GET['uid'];
$query=mysqli_query($con,"select * from vaccines where id='$userid'");
