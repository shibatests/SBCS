            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Add new vaccine  </h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active"> new vaccine </li>
                        </ol>
...
if(isset($_POST['submit']))
{
    ...
    $msg=mysqli_query($con,"insert into vaccines(name,period,message) values('$name','$period','$message')");

if($msg)
{
    echo "<script>alert('Added successfully');</script>";
    echo "<script type='text/javascript'> document.location = 'managevaccines.php'; </script>";
}
}
...
<hr />
                                        <h3 class="text-center font-weight-light my-4">new vaccine profile</h3></div>
                                    <div class="card-body">
...
<input class="form-control" id="fname" name="name" type="text" placeholder="Enter vaccine name " required />
<label for="inputFirstName">vaccine name</label>
</div>
</div>
